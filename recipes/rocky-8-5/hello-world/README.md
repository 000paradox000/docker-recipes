...
```shell
cd recipes/rocky-8-5/hello-world
docker build -t docker_recipes_recipes_rocky_8_5_hello_world_image .
docker run --rm -t docker_recipes_recipes_rocky_8_5_hello_world_image
docker image rm docker_recipes_recipes_rocky_8_5_hello_world_image
```
